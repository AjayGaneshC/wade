...
Original file is located at
    https://colab.research.google.com/drive/16M4Taw6SNf-pq4idHCcsPpzrGhHhAC_W
"""
...
# Title
st.markdown("<h1 class='animate__animated animate__bounceIn' style='text-align:center; color:#ffffff;'>VIZAI - Regression Visualization</h1>", unsafe_allow_html=True)
...
# Sidebar
with container:
    st.markdown("<h2 style='color:#ffffff;'>Regression Options</h2>", unsafe_allow_html=True)
